...
fragment ARRAY: 'A';
ARRAY_BEGIN: ARRAY -> pushMode(M_ARRAY);
ARRAY_END: END ARRAY;

fragment CLASS: 'C';
CLASS_BEGIN: CLASS -> pushMode(M_CLASS);
CLASS_END: END CLASS;

fragment STRUCT: 'S';
STRUCT_BEGIN: STRUCT -> pushMode(M_STRUCT);
STRUCT_END: END STRUCT;

fragment TYPE_LIST: 'T';
TYPE_LIST_BEGIN: TYPE_LIST -> pushMode(M_TYPE_LIST);
TYPE_LIST_END: END TYPE_LIST;

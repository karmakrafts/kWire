...
@JvmInline
value class BytePtr(val value: Pointer) {
    inline operator fun plus(other: NUInt): BytePtr = BytePtr(value + other)
    inline operator fun minus(other: NUInt): BytePtr = BytePtr(value - other)

    inline operator fun get(index: Int): Byte = Memory.readByte(value + index.toNUInt())
    inline operator fun set(index: Int, value: Byte) = Memory.writeByte(this.value + index.toNUInt(), value)
    inline operator fun get(index: Long): Byte = Memory.readByte(value + index.toNUInt())
    inline operator fun set(index: Long, value: Byte) = Memory.writeByte(this.value + index.toNUInt(), value)
    inline operator fun get(index: NUInt): Byte = Memory.readByte(value + index)
    inline operator fun set(index: NUInt, value: Byte) = Memory.writeByte(this.value + index, value)
}

inline fun Pointer.asBytePtr(): BytePtr = BytePtr(this)

@JvmInline
value class ShortPtr(val value: Pointer) {
...
@JvmInline
value class IntPtr(val value: Pointer) {
...
@JvmInline
value class LongPtr(val value: Pointer) {
...
@JvmInline
value class NIntPtr(val value: Pointer) {
    inline operator fun plus(other: NUInt): NIntPtr = NIntPtr(value + other * NInt.SIZE_BYTES.toNUInt())
    inline operator fun minus(other: NUInt): NIntPtr = NIntPtr(value - other * NInt.SIZE_BYTES.toNUInt())

    inline operator fun get(index: Int): NInt =
        Memory.readNInt(value + index.toNUInt() * NInt.SIZE_BYTES.toNUInt())

    inline operator fun set(index: Int, value: NInt) =
        Memory.writeNInt(this.value + index.toNUInt() * NInt.SIZE_BYTES.toNUInt(), value)
    ...
    inline operator fun get(index: NUInt): NInt =
        Memory.readNInt(value + index * NInt.SIZE_BYTES.toNUInt())

    inline operator fun set(index: NUInt, value: NInt) =
        Memory.writeNInt(this.value + index * NInt.SIZE_BYTES.toNUInt(), value)
}
...
@JvmInline
value class UBytePtr(val value: Pointer) {
...
@JvmInline
value class UShortPtr(val value: Pointer) {
...
@JvmInline
value class UIntPtr(val value: Pointer) {
...
@JvmInline
value class ULongPtr(val value: Pointer) {
...
@JvmInline
value class NUIntPtr(val value: Pointer) {
    inline operator fun plus(other: NUInt): NUIntPtr = NUIntPtr(value + other * NUInt.SIZE_BYTES.toNUInt())
    inline operator fun minus(other: NUInt): NUIntPtr = NUIntPtr(value - other * NUInt.SIZE_BYTES.toNUInt())

    inline operator fun get(index: Int): NUInt =
        Memory.readNUInt(value + index.toNUInt() * NUInt.SIZE_BYTES.toNUInt())

    inline operator fun set(index: Int, value: NUInt) =
        Memory.writeNUInt(this.value + index.toNUInt() * NUInt.SIZE_BYTES.toNUInt(), value)
    ...
    inline operator fun get(index: NUInt): NUInt =
        Memory.readNUInt(value + index * NUInt.SIZE_BYTES.toNUInt())

    inline operator fun set(index: NUInt, value: NUInt) =
        Memory.writeNUInt(this.value + index * NUInt.SIZE_BYTES.toNUInt(), value)
}
...
@JvmInline
value class FloatPtr(val value: Pointer) {
...
@JvmInline
value class DoublePtr(val value: Pointer) {

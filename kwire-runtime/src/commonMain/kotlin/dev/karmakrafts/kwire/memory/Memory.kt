...
interface Memory : Allocator {
     ...
     */
    fun zero(address: Ptr<*>, size: NUInt) = set(address, 0, size)
     ...
     */
    fun set(address: Ptr<*>, value: Byte, size: NUInt)
     ...
     */
    fun copy(source: @Const Ptr<*>, dest: Ptr<*>, size: NUInt)
     ...
     * @param size The number of bytes to copy
     */
    fun copyOverlapping(source: @Const Ptr<*>, dest: Ptr<*>, size: NUInt)
     ...
     */
    fun compare(first: @Const Ptr<*>, second: @Const Ptr<*>, size: NUInt): Int
     ...
     */
    fun strlen(address: @Const Ptr<*>): NUInt
     ...
     */
    fun strcpy(source: @Const Ptr<*>, dest: Ptr<*>)
     ...
     * @return A negative value if first < second, zero if first == second, or a positive value if first > second
     */
    fun strcmp(first: @Const Ptr<*>, second: @Const Ptr<*>): Int
     ...
     */
    @KWireCompilerApi
    fun readByte(address: @Const Ptr<*>): Byte
     ...
     */
    @KWireCompilerApi
    fun readShort(address: @Const Ptr<*>): Short
     ...
     */
    @KWireCompilerApi
    fun readInt(address: @Const Ptr<*>): Int
     ...
     */
    @KWireCompilerApi
    fun readLong(address: @Const Ptr<*>): Long
     ...
     */
    @KWireCompilerApi
    fun readNInt(address: @Const Ptr<*>): NInt
     ...
     */
    @KWireCompilerApi
    fun readPointer(address: @Const Ptr<*>): Ptr<CVoid>
     ...
     */
    @KWireCompilerApi
    fun readFloat(address: @Const Ptr<*>): Float
     ...
     */
    @KWireCompilerApi
    fun readDouble(address: @Const Ptr<*>): Double
     ...
     */
    @KWireCompilerApi
    fun readNFloat(address: @Const Ptr<*>): NFloat
     ...
     */
    @KWireCompilerApi
    fun readUByte(address: @Const Ptr<*>): UByte = readByte(address).toUByte()
     ...
     */
    @KWireCompilerApi
    fun readUShort(address: @Const Ptr<*>): UShort = readShort(address).toUShort()
     ...
     */
    @KWireCompilerApi
    fun readUInt(address: @Const Ptr<*>): UInt = readInt(address).toUInt()
     ...
     */
    @KWireCompilerApi
    fun readULong(address: @Const Ptr<*>): ULong = readLong(address).toULong()
     ...
     */
    @KWireCompilerApi
    fun readNUInt(address: @Const Ptr<*>): NUInt = readNInt(address).toUnsigned()
     ...
     */
    fun readBytes(address: @Const Ptr<*>, data: ByteArray, dataStart: Int = 0, dataEnd: Int = data.size)
     ...
     * @param dataEnd The ending index in the array (exclusive)
     */
    fun readShorts(address: @Const Ptr<*>, data: ShortArray, dataStart: Int = 0, dataEnd: Int = data.size)
     ...
     * @param dataEnd The ending index in the array (exclusive)
     */
    fun readInts(address: @Const Ptr<*>, data: IntArray, dataStart: Int = 0, dataEnd: Int = data.size)
     ...
     * @param dataEnd The ending index in the array (exclusive)
     */
    fun readLongs(address: @Const Ptr<*>, data: LongArray, dataStart: Int = 0, dataEnd: Int = data.size)
     ...
     * @param dataEnd The ending index in the array (exclusive)
     */
    fun readNInts(address: @Const Ptr<*>, data: NIntArray, dataStart: Int = 0, dataEnd: Int = data.size)
     ...
     * @param dataEnd The ending index in the array (exclusive)
     */
    fun readFloats(address: @Const Ptr<*>, data: FloatArray, dataStart: Int = 0, dataEnd: Int = data.size)
     ...
     * @param dataEnd The ending index in the array (exclusive)
     */
    fun readDoubles(address: @Const Ptr<*>, data: DoubleArray, dataStart: Int = 0, dataEnd: Int = data.size)
     ...
     * @param dataEnd The ending index in the array (exclusive)
     */
    fun readNFloats(address: @Const Ptr<*>, data: NFloatArray, dataStart: Int = 0, dataEnd: Int = data.size)
     ...
     * @param dataEnd The ending index in the array (exclusive)
     */
    fun readPointers(address: @Const Ptr<*>, data: PtrArray<*>, dataStart: Int = 0, dataEnd: Int = data.size)
     ...
     */
    @KWireCompilerApi
    fun writeByte(address: Ptr<*>, value: Byte)
     ...
     */
    @KWireCompilerApi
    fun writeShort(address: Ptr<*>, value: Short)
     ...
     */
    @KWireCompilerApi
    fun writeInt(address: Ptr<*>, value: Int)
     ...
     */
    @KWireCompilerApi
    fun writeLong(address: Ptr<*>, value: Long)
     ...
     */
    @KWireCompilerApi
    fun writeNInt(address: Ptr<*>, value: NInt)
     ...
     */
    @KWireCompilerApi
    fun writePointer(address: Ptr<*>, value: Ptr<*>)
     ...
     */
    @KWireCompilerApi
    fun writeFloat(address: Ptr<*>, value: Float)
     ...
     */
    @KWireCompilerApi
    fun writeDouble(address: Ptr<*>, value: Double)
     ...
     */
    @KWireCompilerApi
    fun writeNFloat(address: Ptr<*>, value: NFloat)
     ...
     */
    @KWireCompilerApi
    fun writeUByte(address: Ptr<*>, value: UByte) = writeByte(address, value.toByte())
     ...
     */
    @KWireCompilerApi
    fun writeUShort(address: Ptr<*>, value: UShort) = writeShort(address, value.toShort())
     ...
     */
    @KWireCompilerApi
    fun writeUInt(address: Ptr<*>, value: UInt) = writeInt(address, value.toInt())
     ...
     */
    @KWireCompilerApi
    fun writeULong(address: Ptr<*>, value: ULong) = writeLong(address, value.toLong())
     ...
     */
    @KWireCompilerApi
    fun writeNUInt(address: Ptr<*>, value: NUInt) = writeNInt(address, value.toNInt())
     ...
     */
    @KWireCompilerApi
    fun writeBytes(address: Ptr<*>, data: ByteArray, dataStart: Int = 0, dataEnd: Int = data.size)
     ...
     */
    @KWireCompilerApi
    fun writeShorts(address: Ptr<*>, data: ShortArray, dataStart: Int = 0, dataEnd: Int = data.size)
     ...
     */
    @KWireCompilerApi
    fun writeInts(address: Ptr<*>, data: IntArray, dataStart: Int = 0, dataEnd: Int = data.size)
     ...
     */
    @KWireCompilerApi
    fun writeLongs(address: Ptr<*>, data: LongArray, dataStart: Int = 0, dataEnd: Int = data.size)
     ...
     */
    @KWireCompilerApi
    fun writeNInts(address: Ptr<*>, data: NIntArray, dataStart: Int = 0, dataEnd: Int = data.size)
     ...
     */
    @KWireCompilerApi
    fun writeFloats(address: Ptr<*>, data: FloatArray, dataStart: Int = 0, dataEnd: Int = data.size)
     ...
     */
    @KWireCompilerApi
    fun writeDoubles(address: Ptr<*>, data: DoubleArray, dataStart: Int = 0, dataEnd: Int = data.size)
     ...
     */
    @KWireCompilerApi
    fun writeNFloats(address: Ptr<*>, data: NFloatArray, dataStart: Int = 0, dataEnd: Int = data.size)
     ...
     */
    @KWireCompilerApi
    fun writePointers(address: Ptr<*>, data: PtrArray<*>, dataStart: Int = 0, dataEnd: Int = data.size)
     ...
     * @param dataEnd The ending index in the array (exclusive)
     */
    fun readUBytes(address: @Const Ptr<*>, data: UByteArray, dataStart: Int = 0, dataEnd: Int = data.size) =
     ...
     * @param dataEnd The ending index in the array (exclusive)
     */
    fun readUShorts(address: @Const Ptr<*>, data: UShortArray, dataStart: Int = 0, dataEnd: Int = data.size) =
     ...
     * @param dataEnd The ending index in the array (exclusive)
     */
    fun readUInts(address: @Const Ptr<*>, data: UIntArray, dataStart: Int = 0, dataEnd: Int = data.size) =
     ...
     * @param dataEnd The ending index in the array (exclusive)
     */
    fun readULongs(address: @Const Ptr<*>, data: ULongArray, dataStart: Int = 0, dataEnd: Int = data.size) =
     ...
     * @param dataEnd The ending index in the array (exclusive)
     */
    fun readNUInts(address: @Const Ptr<*>, data: NUIntArray, dataStart: Int = 0, dataEnd: Int = data.size) =
     ...
     * @param dataEnd The ending index in the array (exclusive)
     */
    fun writeUBytes(address: Ptr<*>, data: UByteArray, dataStart: Int = 0, dataEnd: Int = data.size) =
     ...
     * @param dataEnd The ending index in the array (exclusive)
     */
    fun writeUShorts(address: Ptr<*>, data: UShortArray, dataStart: Int = 0, dataEnd: Int = data.size) =
     ...
     * @param dataEnd The ending index in the array (exclusive)
     */
    fun writeUInts(address: Ptr<*>, data: UIntArray, dataStart: Int = 0, dataEnd: Int = data.size) =
     ...
     * @param dataEnd The ending index in the array (exclusive)
     */
    fun writeULongs(address: Ptr<*>, data: ULongArray, dataStart: Int = 0, dataEnd: Int = data.size) =
     ...
     * @param dataEnd The ending index in the array (exclusive)
     */
    fun writeNUInts(address: Ptr<*>, data: NUIntArray, dataStart: Int = 0, dataEnd: Int = data.size) =
     ...
     */
    @KWireCompilerApi
    fun readBytes(address: @Const Ptr<*>, size: Int): ByteArray = ByteArray(size).apply {
     ...
     */
    @KWireCompilerApi
    fun readShorts(address: @Const Ptr<*>, size: Int): ShortArray = ShortArray(size).apply {
     ...
     */
    @KWireCompilerApi
    fun readInts(address: @Const Ptr<*>, size: Int): IntArray = IntArray(size).apply {
     ...
     */
    @KWireCompilerApi
    fun readLongs(address: @Const Ptr<*>, size: Int): LongArray = LongArray(size).apply {
     ...
     */
    @KWireCompilerApi
    fun readNInts(address: @Const Ptr<*>, size: Int): NIntArray = nIntArray(size).apply {
     ...
     */
    @KWireCompilerApi
    fun readUBytes(address: @Const Ptr<*>, size: Int): UByteArray = UByteArray(size).apply {
     ...
     */
    @KWireCompilerApi
    fun readUShorts(address: @Const Ptr<*>, size: Int): UShortArray = UShortArray(size).apply {
     ...
     */
    @KWireCompilerApi
    fun readUInts(address: @Const Ptr<*>, size: Int): UIntArray = UIntArray(size).apply {
     ...
     */
    @KWireCompilerApi
    fun readULongs(address: @Const Ptr<*>, size: Int): ULongArray = ULongArray(size).apply {
     ...
     */
    @KWireCompilerApi
    fun readNUInts(address: @Const Ptr<*>, size: Int): NUIntArray = nUIntArray(size).apply {
     ...
     */
    @KWireCompilerApi
    fun readFloats(address: @Const Ptr<*>, size: Int): FloatArray = FloatArray(size).apply {
     ...
     */
    @KWireCompilerApi
    fun readDoubles(address: @Const Ptr<*>, size: Int): DoubleArray = DoubleArray(size).apply {
     ...
     */
    @KWireCompilerApi
    fun readNFloats(address: @Const Ptr<*>, size: Int): NFloatArray = nFloatArray(size).apply {
     ...
     */
    @KWireCompilerApi
    fun readPointers(address: @Const Ptr<*>, size: Int): PtrArray<Ptr<CVoid>> = PtrArray<Ptr<CVoid>>(size).apply {
